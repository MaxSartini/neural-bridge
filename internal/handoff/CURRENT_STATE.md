...
- Live handoff:
  `/Users/maxsartini/Neural Bridge/internal/handoff/CURRENT_STATE.md`

Read the repository contract, complete master specification, and this file in that order.
For the current action, read only these rebuild-protocol sections:
...
The master specification wins over the checklist and this handoff.
