...
- Do not scale AGAIN sparse teacher beyond the bounded pilot from the current evidence; the 2000-budget confirmatory work failed raw sparse, coverage-matched random, and nuisance-control promotion gates even though the true same-budget fixed-random rerun no longer beat hybrid.
