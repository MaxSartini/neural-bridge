...
- For migration, follow `/Users/maxsartini/Neural Bridge/internal/migration/README.md`. Preserve unrelated changes. Commit and push verified current work to `main`; source deletion and active-study migration require explicit approval.
