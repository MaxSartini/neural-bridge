...
def scientific_settings(args: argparse.Namespace) -> dict[str, Any]:
    return {
        ...
        "checkpoint_selection_policy": {
            "binary_without_offset": "maximize_inner_validation_pr_auc",
            "binary_residual": modeling.RESIDUAL_SELECTION_POLICY,
            "continuous": "minimize_inner_validation_loss",
            "selection_min_delta": float(args.selection_min_delta),
            "checkpoint_eligible_epoch": modeling.DEFAULT_CHECKPOINT_MIN_EPOCH,
            "minimum_training_epochs": int(args.min_epochs),
        ...
        "residual_zero_correction_is_selection_candidate": True,
