"""Update grouped compatibility verdict for frozen-AR residual label null.

This script reads the completed grouped compatibility CSV/JSON artifacts and
rewrites only updated verdict/report artifacts. It does not train, score,
...
SCHEMA_VERSION = "again_dense_2hz_phase5_temporal_residual_grouped_compat_updated_verdict_v1"
DEFAULT_BUNDLE = Path("evidence/phase_5_5_grouped_compatibility_20260630_033520")
DEFAULT_REPORT = Path("reports/again_dense_2hz_phase5_temporal_residual_grouped_compat_20260630_033520_UPDATED_VERDICT.md")
...
def compute_updated_gates(bundle: Path) -> dict[str, Any]:
    ...
    updated_label_permutation_pass = bool(label_real_margin_pass and label_fold_seed_pass and label_not_above_ar_pass)
    ...
    gate_checks = {
        ...
        "frozen_ar_residual_aware_label_permutation_pass": updated_label_permutation_pass,
    ...
    return {
        ...
        "verdict_update_policy": "frozen_ar_residual_aware_label_permutation_null",
        "no_retraining": True,
        "no_new_scoring": True,
        ...
        "updated_label_permutation_policy": {
...
- Updated label permutation pass: `{gates['frozen_ar_residual_aware_label_permutation_pass']}`
...
- Updated grouped compatibility pass: `{gates['grouped_compatibility_pass']}`
...
def main() -> int:
    ...
    gates = compute_updated_gates(bundle)
    promotion = bundle / "promotion"
    reports = bundle / "reports"
    write_json(promotion / "temporal_residual_grouped_compat_updated_gates.json", gates)
    write_json(promotion / "temporal_residual_grouped_compat_updated_adversarial_verdict.json", gates)
    write_json(
        promotion / "temporal_residual_grouped_compat_updated_failure_reasons.json",
        {"failed_gates": gates["failed_gates"], "recommendation": gates["recommendation"]},
    )
    bundle_report = reports / "again_dense_2hz_phase5_temporal_residual_grouped_compat_20260630_033520_UPDATED_VERDICT.md"
    ...
    print(
        json.dumps(
            fr.clean_json(
                {
                    "updated_grouped_compatibility_pass": gates["grouped_compatibility_pass"],
