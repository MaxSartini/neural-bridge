...
PCA_OVERSAMPLE_DIVISOR = 4
PCA_POWER_ITERATIONS = 6
PCA_JACOBI_MAX_SWEEPS = 12
PCA_JACOBI_TOLERANCE = 1e-5
PCA_ORTHOGONALITY_TOLERANCE = 5e-3
PCA_SUBSPACE_STABILITY_FLOOR = 0.90
