...
- Raw predicted cortical/fMRI features alone fail badly on AGAIN; the Neural Bridge pipeline is what makes those predicted cortical/fMRI response features generated from video by upstream models trained on brain cortical response data useful for controlled future event-ranking.
