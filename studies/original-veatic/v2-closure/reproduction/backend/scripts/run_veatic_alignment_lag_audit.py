"""Dedicated VEATIC 124 alignment, lag, and evaluation audit.
...
def main() -> None:
    ...
    payload = {
        "schema_version": "veatic_124_alignment_lag_audit_v1",
    ...
    (out_dir / "veatic_124_alignment_lag_audit_20260616.json").write_text(json.dumps(payload, indent=2), encoding="utf-8")
    write_final_report(out_dir / "veatic_124_alignment_lag_audit_20260616.md", manifest_rows, resampled_rows, global_rows, per_video_lag_rows, causal_rows, label_rows, horizon_rows, onset_rows, balanced_rows, cross_rows, interpolation_rows, subset_rows, ar_behavior_rows, candidate_rows, confirm_rows, bootstrap_rows)
    print(json.dumps({"report": str(out_dir / "veatic_124_alignment_lag_audit_20260616.md"), "outputs": len(payload["outputs"])}, indent=2))
...
def write_final_report(path: Path, manifest_rows: list[dict[str, Any]], resampled_rows: list[dict[str, Any]], global_rows: list[dict[str, Any]], per_video_rows: list[dict[str, Any]], causal_rows: list[dict[str, Any]], label_rows: list[dict[str, Any]], horizon_rows: list[dict[str, Any]], onset_rows: list[dict[str, Any]], balanced_rows: list[dict[str, Any]], cross_rows: list[dict[str, Any]], interpolation_rows: list[dict[str, Any]], subset_rows: list[dict[str, Any]], ar_rows: list[dict[str, Any]], candidate_rows: list[dict[str, Any]], confirm_rows: list[dict[str, Any]], bootstrap_rows: list[dict[str, Any]]) -> None:
    ...
    lines = [
        "# VEATIC 124 Alignment Lag Audit",
        "",
