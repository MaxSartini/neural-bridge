...
- Hybrid AR + telemetry + V-JEPA-B + locked sparse PCA32 causal PR-AUC: `27.65%`
- Hybrid AR + telemetry + V-JEPA-B + train-selected sparse PCA causal PR-AUC: `21.95%`
- Hybrid AR + telemetry + V-JEPA-B + sparse PCA128 causal PR-AUC: `27.30%`
...
- sparse PCA128 vs AR + telemetry + V-JEPA-B: pass (delta 5.93 pp)
...
- locked PCA32 vs AR + telemetry + V-JEPA-B: pass (delta 6.28 pp)
- AR + telemetry + V-JEPA-B + locked PCA32 vs AR + telemetry + V-JEPA-B: pass (delta 6.28 pp)
- train-selected small PCA vs AR-only: pass (delta 0.58 pp)
- train-selected small PCA vs AR + telemetry + V-JEPA-B: pass (delta 0.58 pp)
- AR + telemetry + V-JEPA-B + train-selected small PCA vs AR + telemetry + V-JEPA-B: pass (delta 0.58 pp)
...
- Per-video and per-game summaries are written under `outputs/again_sparse_tribe_teacher_2000_20260622_2000_small_pca_confirmatory/`.
...
- PCA32 remains a useful diagnostic compressed bridge, but it did not confirm as a promotion lane because matched-random sparse controls were stronger.
