...
- `future_spike_1_3s_ge_0.05`: videos `4`, rows `36`, events `7`, PR-AUC `53.82%`, ROC-AUC `87.31%`
- `future_spike_1_3s_ge_0.075`: videos `4`, rows `36`, events `4`, PR-AUC `19.13%`, ROC-AUC `55.47%`
